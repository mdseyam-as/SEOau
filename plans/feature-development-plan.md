...
## 5. "Киллер-фича" для GEO - Цитирование источников (Citations)

### Проблема
GEO-режим требует достоверности. AI может генерировать информацию без ссылок на источники, что снижает доверие к контенту.
...
<div className="generation-options">
  <label>
    ...
    />
    Включить цитирование источников (GEO)
  </label>
</div>
```
