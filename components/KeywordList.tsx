...
export const KeywordList: React.FC<KeywordListProps> = ({ keywords }) => {
  ...
  return (
    <div className="app-light-card p-3 sm:p-4 md:p-6 max-h-[200px] sm:max-h-[300px] md:max-h-[400px] overflow-hidden flex flex-col">
      <div className="flex items-center justify-between mb-2 sm:mb-3 md:mb-4">
        <h3 className="font-bold text-slate-900 flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm md:text-base">
          <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[linear-gradient(135deg,rgba(16,185,129,0.12),rgba(56,189,248,0.08))] border border-emerald-200/70">
            <BarChart2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-600" />
          </div>
          Ключи ({keywords.length})
        </h3>
        <span className="text-[9px] sm:text-[10px] md:text-xs bg-emerald-50 text-emerald-700 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full border border-emerald-100">
          По частоте
        </span>
      </div>
