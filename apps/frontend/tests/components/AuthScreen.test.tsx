...
describe('AuthScreen Component', () => {
    ...
    describe('Rendering', () => {
        it('should render login form when not in Telegram and server is online', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText('Вход в приложение')).toBeDefined();
            });
        ...
        it('should render dev mode button when server is online', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText('Войти в dev-режиме')).toBeDefined();
            });
        });
    ...
    describe('User Interactions', () => {
        it('should handle dev login when form is submitted', async () => {
            ...
            const button = screen.getByText('Войти в dev-режиме');
